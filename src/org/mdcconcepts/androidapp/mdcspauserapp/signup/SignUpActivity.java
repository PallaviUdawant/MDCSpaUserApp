package org.mdcconcepts.androidapp.mdcspauserapp.signup;
...
import org.mdcconcepts.androidapp.customitems.CustomValidator;
...
public class SignUpActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Txt_Uname=(TextView)findViewById(R.id.txt_username_create_acc);
		Txt_Addr=(TextView)findViewById(R.id.txt_addr__create_acc);
		Txt_Anniversary=(TextView)findViewById(R.id.txt_anniversary_create_acc);
		Txt_Confirm_Password=(TextView)findViewById(R.id.txt_confirm_create_acc);
		Txt_DoB=(TextView)findViewById(R.id.txt_dob_create_acc);
		Txt_Email=(TextView)findViewById(R.id.txt_email_create_acc);
		Txt_Mobile=(TextView)findViewById(R.id.txt_contact_num_create_acc);
		Txt_Password=(TextView)findViewById(R.id.txt_pass_create_acc);
		...
		Txt_Anniversary.setTypeface(font);
		Txt_Confirm_Password.setTypeface(font);
		Txt_DoB.setTypeface(font);
		Txt_Email.setTypeface(font);
		Txt_Mobile.setTypeface(font);
		Txt_Password.setTypeface(font);
		txt_Full_Name.setTypeface(font);
		txt_alreadyHaveAccount.setTypeface(font);
		...
		txt_alreadyHaveAccount.setOnClickListener(new View.OnClickListener() {
