...
public class AlbumsAdapter extends ArrayAdapter<Album> {
	...
	public AlbumsAdapter(Context context, int textViewResourceId,
			List<Album> albums) {
	...
	public View getView(int position, View row, ViewGroup parent) {
		...
		if (row == null) {
			...
			albumHolder.coverImage = (ImageView) row
					.findViewById(R.id.coveralbum);

			albumHolder.albumName = (TextView) row.findViewById(R.id.albumname);
			albumHolder.photoCount = (TextView) row
		...
		albumHolder.photoCount.setText(String.valueOf(bean.getPhotosCount())
				+ " Photos");
