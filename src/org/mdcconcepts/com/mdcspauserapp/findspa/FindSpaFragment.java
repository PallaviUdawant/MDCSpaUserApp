...
public class FindSpaFragment extends Fragment implements OnScrollListener {

	ListView listview_spa;
	NearestSpaListviewAdapter adapter;
	Typeface font;
		...
		case 0:
			...
			if (isDataAvailable) {
				if ((loadedItems == totalItemCount) && !isloading) {
					...
					if (getTenSpaTask != null
							&& (getTenSpaTask.getStatus() == AsyncTask.Status.FINISHED)) {
						getTenSpaTask = new GetTenSpa();
						getTenSpaTask.execute();
